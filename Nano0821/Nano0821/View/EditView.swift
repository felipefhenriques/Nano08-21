...
class EditView: UIScrollView {
    ...
    let fdDay = CustomTextField(text: "Insira o Dia do Nascimento (número)", fontSize: fontSize)
    let fdMonth = CustomTextField(text: "Insira o Mês do Nascimento (número)", fontSize: fontSize)
    let fdYear = CustomTextField(text: "Insira o Ano do Nascimento (número)", fontSize: fontSize)
    let fdColor = CustomTextField(text: "Insira a Cor", fontSize: fontSize)
    let fdWeight = CustomTextField(text: "Insira o Peso (número)", fontSize: fontSize)
